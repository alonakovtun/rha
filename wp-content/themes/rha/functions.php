...
function rha_setup() {
	/*
		...
		* If you're building a theme based on rha, use a find and replace
...
function rha_scripts() {
	wp_enqueue_style( 'rha-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'rha-style', 'rtl', 'replace' );

	wp_enqueue_script( 'rha-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );

	wp_enqueue_style ('main-style', get_template_directory_uri().'/assets/css/main.min.css');
	wp_enqueue_script ('rha-scripts', get_template_directory_uri().'/assets/js/main.min.js');
